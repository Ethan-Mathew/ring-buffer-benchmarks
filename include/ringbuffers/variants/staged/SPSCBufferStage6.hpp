...
public:
    explicit SPSCBufferStage6(std::size_t bufferSize)
    {
        if (bufferSize < 1)
        {
            throw std::invalid_argument("SPSCBufferStage6 capacity must be greater than or equal to 1");
        }
    ...
    SPSCBufferStage6(const SPSCBufferStage6&) = delete;
    SPSCBufferStage6& operator=(const SPSCBufferStage6&) = delete;
    SPSCBufferStage6(SPSCBufferStage6&&) = delete;
    SPSCBufferStage6& operator=(SPSCBufferStage6&&) = delete;
