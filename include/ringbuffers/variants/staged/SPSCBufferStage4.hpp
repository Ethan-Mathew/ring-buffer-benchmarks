...
public:
    explicit SPSCBufferStage4(std::size_t bufferSize)
    {
        if (bufferSize < 1)
        {
            throw std::invalid_argument("SPSCBufferStage4 capacity must be greater than or equal to 1");
        }
    ...
    SPSCBufferStage4(const SPSCBufferStage4&) = delete;
    SPSCBufferStage4& operator=(const SPSCBufferStage4&) = delete;
    SPSCBufferStage4(SPSCBufferStage4&&) = delete;
    SPSCBufferStage4& operator=(SPSCBufferStage4&&) = delete;
