...
public:
    explicit SPSCBufferStage2(std::size_t bufferSize)
    {
        if (bufferSize < 1)
        {
            throw std::invalid_argument("SPSCBufferStage2 capacity must be greater than or equal to 1");
        }
    ...
    SPSCBufferStage2(const SPSCBufferStage2&) = delete;
    SPSCBufferStage2& operator=(const SPSCBufferStage2&) = delete;
    SPSCBufferStage2(SPSCBufferStage2&&) = delete;
    SPSCBufferStage2& operator=(SPSCBufferStage2&&) = delete;
