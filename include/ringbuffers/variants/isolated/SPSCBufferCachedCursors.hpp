...
class SPSCBufferCachedCursors
{
public:
    explicit SPSCBufferCachedCursors(std::size_t bufferSize)
    {
        if (bufferSize < 1)
        {
            throw std::invalid_argument("SPSCBufferCachedCursors capacity must be greater than or equal to 1");
        }
    ...
    SPSCBufferCachedCursors(const SPSCBufferCachedCursors&) = delete;
    SPSCBufferCachedCursors& operator=(const SPSCBufferCachedCursors&) = delete;
    SPSCBufferCachedCursors(SPSCBufferCachedCursors&&) = delete;
    SPSCBufferCachedCursors& operator=(SPSCBufferCachedCursors&&) = delete;
    ...
    void emplace(Args&&... args)
    {
        ...
        {
            popCursorCache_ = popCursor_.load(std::memory_order_seq_cst);
        }
    ...
    T* front()
    {
        ...
        {
            pushCursorCache_ = pushCursor_.load(std::memory_order_seq_cst);
