...
class SPSCBufferMemOrder
{
public:
    explicit SPSCBufferMemOrder(std::size_t bufferSize)
    {
        if (bufferSize < 1)
        {
            throw std::invalid_argument("SPSCBufferMemOrder capacity must be greater than or equal to 1");
        }
    ...
    SPSCBufferMemOrder(const SPSCBufferMemOrder&) = delete;
    SPSCBufferMemOrder& operator=(const SPSCBufferMemOrder&) = delete;
    SPSCBufferMemOrder(SPSCBufferMemOrder&&) = delete;
    SPSCBufferMemOrder& operator=(SPSCBufferMemOrder&&) = delete;
